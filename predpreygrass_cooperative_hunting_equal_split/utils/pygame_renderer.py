...
class PyGameRenderer:
    ...
    def _draw_header_banner(self) -> None:
        ...
        title = self.panel_large_font.render("Predator-Prey Cooperative Hunting Equal-Split Replay", True, self.style.header_text)
...
def main() -> None:
    raise RuntimeError(
        ...
        "'predpreygrass_cooperative_hunting_equal_split/cooperative_hunting.py' or use the VS Code "
        "launch configuration 'Python: cooperative_hunting_equal_split'."
    )
