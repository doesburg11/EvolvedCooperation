...
No CLI is used. Edit the configuration block below, then run:
  ...
  ./.conda/bin/python -m predpreygrass_cooperative_hunting_equal_split.utils.compare_de_novo_vs_supported_baselines
...
if not __package__:
    raise SystemExit(
        ...
        "'./.conda/bin/python -m "
        "predpreygrass_cooperative_hunting_equal_split.utils.compare_de_novo_vs_supported_baselines'."
    )
