#!/usr/bin/env python3
"""
Active runtime parameters for the refuge-enabled `cooperative_hunting_refuge.py`
equal-split variant.
...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "grid_width": 60,
    "grid_height": 60,
    "initial_predator_count": 35,
    "initial_prey_count": 1000,
    "initial_predator_energy": 3.4,
    "initial_predator_hunt_investment_trait_min": 0.0,
    "initial_predator_hunt_investment_trait_max": 0.45,
    "simulation_steps": 10000,
    # Predator energetics and reproduction.
    "predator_metabolic_cost": 0.053,
    "predator_move_cost_per_unit": 0.008,
    "predator_cooperation_cost_per_unit": 0.008,
    "predator_reproduction_energy_threshold": 6.0,
    "predator_reproduction_probability": 0.004,
    "predator_crowding_soft_cap": 350,
    ...
    "prey_reproduction_probability": 0.12,
