#!/usr/bin/env python3
"""
Frozen configuration for the GitHub Pages cooperative-hunting equal-split demo.

This module preserves the parameter set used by the website replay as of
2026-04-05. Continue tuning the live model in
`emerging_cooperation_config.py`; update this file only when you intentionally
