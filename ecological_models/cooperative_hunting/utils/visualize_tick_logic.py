...
Run from the repo root with:
  ./.conda/bin/python -m ecological_models.cooperative_hunting.utils.visualize_tick_logic

Output:
  assets/cooperative_hunting/tick_logic_example.svg
  assets/cooperative_hunting/tick_logic_gridworld.svg
"""
...
def plot_tick_example(outfile: Path) -> None:
    ...
    _text(
        ...
        width / 2,
        42,
        "Predator-Cooperative-Hunting Model: One Tick Worked Example",
        size=28,
        weight="700",
        color="#101820",
        family="Arial",
...
def main() -> None:
    ...
    ap.add_argument(
        "--outfile",
        type=Path,
        default=Path("assets/cooperative_hunting/tick_logic_example.svg"),
    )
    ap.add_argument(
        "--grid-outfile",
        type=Path,
        default=Path("assets/cooperative_hunting/tick_logic_gridworld.svg"),
    )
    args = ap.parse_args()
