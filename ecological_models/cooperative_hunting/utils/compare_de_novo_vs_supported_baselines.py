...
No CLI is used. Edit the configuration block below, then run:
  ...
  ./.conda/bin/python -m ecological_models.cooperative_hunting.utils.compare_de_novo_vs_supported_baselines
...
if not __package__:
    raise SystemExit(
        ...
        "'./.conda/bin/python -m "
        "ecological_models.cooperative_hunting.utils.compare_de_novo_vs_supported_baselines'."
    )
