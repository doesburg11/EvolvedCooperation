...
On 2026-04-17, `ecological_models/spatial_prisoners_dilemma/` was added as a new experimental
evolved-cooperation module.

Stepwise impact:

1. The repo now contains a third package-level evolved-cooperation model beside
   `ecological_models/spatial_altruism/` and `ecological_models/cooperative_hunting/`.
...
```bash
./.conda/bin/python -m ecological_models.spatial_prisoners_dilemma.spatial_prisoners_dilemma_pygame_ui
```
...
```text
ecological_models/spatial_prisoners_dilemma/data/latest_run.json
```
