#!/usr/bin/env python3
"""
Parallel coexistence sweep for the spatial altruism model.
...
def main():
    ...
    if base_params.model_variant != "steady_state":
        raise SystemExit(
            "ecological_models.spatial_altruism.utils.altruism_grid_search targets the steady-state "
    ...
    print("Results appended to ecological_models/spatial_altruism/data/grid_search_results_extended.csv in batches.")
