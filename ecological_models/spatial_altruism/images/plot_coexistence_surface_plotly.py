...
if __package__ in (None, ""):
    ...
    from ecological_models.spatial_altruism.utils.plotly_browser import show_plotly_figure
else:
    from ..utils.plotly_browser import show_plotly_figure

# Load results
df = pd.read_csv('ecological_models/spatial_altruism/data/grid_search_results.csv')
...
show_plotly_figure(fig, __file__)
