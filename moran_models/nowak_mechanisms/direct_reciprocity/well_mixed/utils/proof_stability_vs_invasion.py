...
Demonstrates that:
  1. coop_majority  — cooperators already common: ALLD cannot invade, cooperation maintained.
  2. alld_majority  — ALLD majority (default start): cooperation emerges in some seeds only.
  3. rare_invaders  — 5% reciprocal in 95% ALLD: cooperation cannot establish.
...
All three scenarios use async one-birth/one-death replacement, weak selection
(temperature = 1.0), p = 0.9, memory enabled — the best conditions identified
in proof_sync_vs_async_replacement.py.
...
SCENARIOS: list[dict[str, Any]] = [
    ...
    {
        "scenario": "rare_invaders",
        "description": "5 % reciprocal in 95 % ALLD — hardest invasion case, cooperation should fail",
        "updates": {
            **_BASE,
