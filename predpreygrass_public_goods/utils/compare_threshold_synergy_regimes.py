...
No CLI is used. Edit the configuration block below, then run:
  ...
  ./.conda/bin/python -m predpreygrass_public_goods.utils.compare_threshold_synergy_regimes
...
if not __package__:
    raise SystemExit(
        ...
        "'./.conda/bin/python -m "
        "predpreygrass_public_goods.utils.compare_threshold_synergy_regimes'."
    )
