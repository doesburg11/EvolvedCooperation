...
`spatial_altruism/config/altruism_config.py`, then run from the repo root:
  ./.conda/bin/python -m spatial_altruism.utils.altruism_grid_search_extended_original
"""
...
def main():
    ...
    found = 0
    n_reps = 5
    csv_path = "spatial_altruism/data/grid_search_results_extended.csv"
    completed = set()
    ...
    print("Results appended to spatial_altruism/data/grid_search_results_extended.csv after each run.")
